...
if (!global.__XJW_LINE_EXPRESS_BOOTSTRAP__) {
  ...
  global.__XJW_LINE_EXPRESS_BOOTSTRAP__ = Object.freeze({
    installed: true,
    version: "current-separated-formal-media-route-bootstrap-v20260821-compact-trial-owner-alert-product-actions",
    capability: "formal-media-routes-no-blank-hero-compact-mobile-cards-independent-trial-checkout-owner-alert-and-simplified-product-actions",
