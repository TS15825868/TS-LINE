...
const CONTENT = [
  ...
  },
  {
    ...
    ig: "30cc 玻璃小瓶，開罐即可飲用，也可依個人習慣溫熱後飲用。",
    fb: "龜鹿飲 30cc 玻璃小瓶，適合外出攜帶、工作空檔或想快速安排的人。開罐即可飲用，也可依個人習慣稍微溫熱後飲用。",
    tags: `${BRAND_TAGS} #龜鹿飲`,
  },
  {
  ...
  },
  {
    ...
    ig: "膏適合固定取用與熱水化開；飲適合開罐即飲與外出攜帶。",
    fb: "龜鹿膏與龜鹿飲的成分方向相近，但型態不同。膏適合喜歡小匙取用、固定安排的人；飲適合外出、工作空檔或偏好開罐即飲的人。",
  },
  {
  ...
  },
  {
    ...
    fb: "詢問產品時，可以直接告訴我們：平常想直接取用、開罐即飲、用熱水沖泡、加入湯品，還是需要家庭大規格。從使用情境開始，比只看產品名稱更容易選擇。",
