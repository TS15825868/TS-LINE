...
const POSTS = [
  ...
  },
  {
    ...
    instagramCaption: [
      ...
      "",
      "30cc瓶裝輕巧好攜帶；180cc鋁袋適合想要較完整即飲份量的時候。可直接飲用，也可依個人習慣溫熱後再喝。",
      "",
      "實際保存與飲用方式請以包裝標示為準。",
      "",
      "#仙加味 #龜鹿飲 #30cc #180cc #日常攜帶",
    ].join("\n"),
    facebookCaption: [
      "龜鹿飲有30cc玻璃瓶與180cc鋁袋兩種規格，可依外出攜帶或日常飲用情境選擇。",
      "",
      "可直接飲用，也可依個人習慣溫熱後再喝。實際保存與飲用方式請以包裝標示為準。",
      "",
      "#仙加味 #龜鹿飲 #日常安排",
    ].join("\n"),
  },
