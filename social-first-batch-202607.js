...
const POSTS = [
  ...
  },
  {
    ...
    instagramCaption: [
      "龜鹿飲30cc為小玻璃罐裝，輕巧好攜帶。",
      "",
      "開罐即可飲用，也可依個人習慣溫熱後再喝；不需要把簡單的日常安排得太複雜。",
      "",
      "實際保存與飲用方式請以包裝標示為準。",
      "",
      "#仙加味 #龜鹿飲 #30cc #小玻璃罐 #日常攜帶",
    ].join("\n"),
    facebookCaption: [
      "龜鹿飲30cc為小玻璃罐裝，適合需要輕巧攜帶的日常情境。",
      "",
  ...
  },
  {
    ...
    instagramCaption: [
      "龜鹿膠規格為600g（1斤）／盒，共32塊，每塊約18.75 g。",
      "",
