...
const PATCHES = {
  sediment: {
    ...
    igBody: "先攪拌或搖勻，確認氣味、包裝與保存狀況。沉澱不能只靠外觀判斷；有疑問可保留完整包裝並拍照詢問。",
    fbBody: "沖泡後若杯底看到少量沉澱，可先攪拌或搖勻，再確認產品氣味、包裝是否完整，以及之前是否依標示保存。不要只靠外觀判斷；仍有疑問時，可保留完整包裝並拍照詢問。",
    tags: `${TAGS} #常見問題 #沖泡觀察`,
  },
  color: {
    knowledgeTopic: "顏色深淺不能單獨判斷",
    title: "小老闆知識 04｜顏色深淺能判斷內容嗎",
    headline: "顏色比較深，就一定代表原料比較多嗎？",
    igBody: "顏色會受到原料、配料、光線、保存狀況與製作方式影響，不能只用深淺判斷。比較時仍要看完整成分與規格。",
    fbBody: "產品顏色可能受到原料、其他配料、拍攝光線、保存狀況及製作方式影響。顏色深淺不能單獨代表內容比例；選擇產品時，仍應回到完整成分、規格與使用方式。",
    tags: `${TAGS} #選購觀念 #產品資訊`,
  },
  "batch-info": {
    ...
    fbBody: "收到產品後，可先確認包裝是否完整、產品名稱與規格是否正確，再查看有效日期與保存方式。外盒可先保留一段時間；如有疑問，拍照聯絡客服會比較容易確認。",
    tags: `${TAGS} #收貨確認 #保存方式`,
  },
  "support-photos": {
    ...
    fbBody: "詢問產品狀況時，建議準備三類照片：完整包裝正反面、產品名稱與有效日期、實際內容物與目前保存狀況。照片盡量清楚並保留整體比例。",
    tags: `${TAGS} #客服提醒 #產品確認`,
  },
  "fair-compare": {
    ...
    igBody: "每種型態都有不同的使用情境。先看成分、規格與使用方式，再依生活節奏選擇能融入日常的產品。",
    fbBody: "龜鹿膏、龜鹿飲、龜鹿湯塊、龜鹿膠與鹿茸粉，各有不同的使用方式。選擇時，先確認偏好的型態、使用時間與日常習慣，再看成分與規格。",
...
function applySocialCopyFix(readStore, writeStore) {
  ...
  return { version: VERSION, updated, total: store.posts.length, imageVersion: IMAGE_VERSION };
}
