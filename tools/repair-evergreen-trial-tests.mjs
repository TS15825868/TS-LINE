...
const officialOrderNotice = '訂單資料與付款方式確認完成後採接單安排製作，約5～7個工作天出貨；不含例假日及物流配送時間。';
patch('data.json', [
  ...
  ['"orderNotice": "訂單資料與付款方式確認後採接單安排製作，約5～7個工作天出貨；不含例假日及物流配送時間。"', `"orderNotice": "${officialOrderNotice}"`],
]);

console.log('PASS：LINE OA測試已同步龜鹿膏2,100／1,800、30cc小玻璃罐、30cc與180cc買10送1，以及約5～7個工作天出貨。');
