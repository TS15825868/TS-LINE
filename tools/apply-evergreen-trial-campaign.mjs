...
data.shippingNotes = {
  ...(data.shippingNotes || {}),
  宅配: '正式訂單資料與付款方式確認後安排製作加工，製作加工約需5～7個工作天；完成後才安排出貨，另加物流配送時間；試喝組郵局宅配運費100元。',
  '7-11賣貨便': '正式訂單資料與付款方式確認後安排製作加工，製作加工約需5～7個工作天；完成後才安排出貨，另加物流配送時間；試喝組7-11店到店運費60元。',
...
server = server.replace(
  /const ORDER_NOTICE = "[^"]*";/,
  'const ORDER_NOTICE = "訂單資料與付款方式確認後安排製作加工，製作加工約需5～7個工作天；完成後才安排出貨，另加物流配送時間。";',
);
