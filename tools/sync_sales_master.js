...
function main() {
  ...
  if (mode === "write") {
    ...
    console.log(`SYNCED LINE OA sales master ${master.version} with 30cc price 60 and fulfillment v3`);
    return;
  }

  console.log(`PASS LINE OA sales master ${master.version}: six products, 30cc price 60, 11 jars 600, fulfillment v3 and official 30cc image`);
}
