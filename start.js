...
if (drink180) {
  drink180.image = `images/products-v3/guilu-drink-180.jpg?v=${VERSION}`;
  drink180.dmImage = `images/dm-final/03_guilu-drink-180cc-dm.jpg?v=${VERSION}`;
  drink180.detailImages = [`images/dm-final/03_guilu-drink-180cc-dm.jpg?v=${VERSION}`];
  drink180.description = "180cc鋁袋包裝，把龜鹿膏的成分方向整理成較大容量的即飲型態。開封即可飲用，也可隔水加熱，或倒入杯中後加熱飲用。";
  drink180.usage = [
    "打開即可飲用。",
    "可隔水加熱後飲用。",
    "亦可倒入杯中後加熱飲用。",
  ...
  drink180.purpose = "較大容量即飲食補";
  drink180.purposeDirection = "適合偏好較大容量即飲、居家安排或溫熱後飲用的人。";
}
