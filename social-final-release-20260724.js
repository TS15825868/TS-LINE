...
const POSTS = Object.freeze([
  ...
  post({
    ...
    productPresentationLocked: true,
    productSpecLocked: true,
    instagramCaption: ["仙加味・龜鹿膠600g，共32塊，每塊約18.75 g。", "", "可依產品標示使用，也可取1塊加入約300～500ml熱水。大包裝適合固定準備，依自己的日常節奏慢慢安排。", "", "保存與使用方式請以包裝標示為準。", "", "#仙加味 #龜鹿膠 #600g #32塊裝 #日常安排"].join("\n"),
    facebookCaption: ["龜鹿膠600g，共32塊，每塊約18.75 g。", "", "大包裝適合固定準備，可依產品標示使用，也可取1塊加入約300～500ml熱水。保存方式請以包裝標示為準。", "", "#仙加味 #龜鹿膠 #600g"].join("\n"),
  }),
  post({
