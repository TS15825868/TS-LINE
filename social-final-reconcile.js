...
const CAPTIONS = Object.freeze({
  ...
  drink: ["龜鹿飲｜30cc／180cc，外出與日常都方便", "龜鹿飲有30cc小玻璃罐與180cc鋁袋兩種規格。可直接飲用，也可依個人習慣溫熱後再喝；實際保存方式以包裝標示為準。", "#仙加味 #龜鹿飲 #30cc #180cc #日常攜帶"],
  ...
  glue: ["龜鹿膠600g｜家庭規格，依日常慢慢安排", "龜鹿膠規格為600g（1斤）／盒，共32塊，每塊約18.75 g。可依產品標示加入熱水化開，也能搭配家常料理。", "#仙加味 #龜鹿膠 #600g #家庭規格"],
});
