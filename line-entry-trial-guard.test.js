...
assert.match(String(bubble.hero?.url || ""), /^https:\/\/ts-line\.onrender\.com\/mascot\/welcome-hd\.jpg\?v=/, "歡迎 Hero 必須走 TS-LINE Render 正式高解析 welcome-hd.jpg，不得回退舊低解析 welcome.jpg 或產品總覽圖");
...
console.log("PASS：歡迎卡固定正式高解析 Hero／精簡文案／申請試喝・看產品・幫我推薦三入口；非歡迎卡完全不受影響。");
