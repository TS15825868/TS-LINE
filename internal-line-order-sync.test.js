...
const inventory = [
  { productId: "paste-100", name: "龜鹿膏100g", price: 1500, stock: 10, reserved: 0, lowStock: 2, movements: [] },
  { productId: "guilu-drink-30", name: "龜鹿飲30cc", price: 50, stock: 100, reserved: 0, lowStock: 12, movements: [] },
];
...
assert.deepStrictEqual(parseOrderLines(priced, inventory), [{ productId: "paste-100", name: "龜鹿膏100g", qty: 2, unitPrice: 1500, subtotal: 3000, pricingLabel: "" }]);
...
assert.ok(promotion.items.includes("方案 買10送2×1"));
...
assert.strictEqual(inventory[1].reserved, 12);
assert.strictEqual(promotion.total, 500);
...
console.log("PASS priced orders, buy-ten-get-two subtotal, reservations, shipment and cancellation lifecycle");
