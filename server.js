...
function choiceHubFlex() {
  return flexCard(
    "仙加味｜怎麼選龜鹿",
    "如果不知道從哪一項開始，可以先依照平常使用習慣選擇。\n\n請點選最接近您的情況：",
    [
      { label: "固定補養", text: "固定補養" },
