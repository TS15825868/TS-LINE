...
assert.strictEqual(clearPolicy.SCHEDULED_AT, "2026-07-29T12:00:00.000Z");
...
assert.strictEqual(batch.POSTS.filter((post) => !post.conditionalWeather)[0].scheduledAt, "2026-07-29T12:00:00.000Z");
console.log("PASS immediate publish remains protected and the first suggested fixed slot is Wednesday 20:00");
